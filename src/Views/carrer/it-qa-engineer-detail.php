            ...
            <div class="pt-5 pb-5">
                <div class="row mb-5">
                    <div class="col-lg-6 col-md-6">
                        ...
                        <h1 class="font-weight-bold text-yellow">IT QA Engineer</h1>
                        ...
                        <div id="collapseOne1" class="collapse show" role="tabpanel" aria-labelledby="headingOne1"
                            ...
                            <div class="card-body">
                                ...
                                <ul>
                                    ...
                                    <li>Having 2-4 years of experience, preferably in start-up companies.</li>

                                    <li>Excellent English communication skills.</li>

                                    <li>Having knowledge in using Selenium and automation testing.</li>

                                    <li>Skilful in using Java.</li>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body pl-0 pr-0">
                                <div class="bg-lightgrey3 pl-4 pr-4 pb-4 pt-0 text-center">
                                    ...
                                    <h3 class="text-yellow font-weight-bold">IT QA Engineer</h3>
                                            ...
                                            <div class="col-md-12">
                                                <div class="md-form mb-0">
                                                    <input type="text" id="position" name="position"
                                                        class="form-control" value="IT QA Engineer" required>
