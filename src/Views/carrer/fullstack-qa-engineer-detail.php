            ...
            <div class="pt-5 pb-5">
                <div class="row mb-5">
                    <div class="col-lg-6 col-md-6">
                        ...
                        <h1 class="font-weight-bold text-yellow">Fullstack QA Engineer</h1>
                    ...
                    <div class="card">
                        ...
                        <div id="collapseOne1" class="collapse show" role="tabpanel" aria-labelledby="headingOne1"
                            ...
                            <div class="card-body">
                                ...
                                <ul>
                                    <li>Engineering wisdom equilvalent to 2-4 year experience, preferably in start-up
                                        companies.</li>
                                    ...
                                    <li>Preferably having product knowledge about financial technology (fintech).</li>

                                    <li>Having knowledge in using JUnit, Rest-Assured, Mockito, Selenium, or Spring
                                        Test.</li>

                                    <li>Having knowledge in REST APIs, cloud services, android platform, web platform.
                                    </li>
                                    ...
                                    <li>Having knowledge about backend build and deployment.</li>

                                    <li>Familiar with unit/ function/ integration test.</li>

                                    <li>Previously experienced in automation testing is preferred.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div id="collapseTwo2" class="collapse" role="tabpanel" aria-labelledby="headingTwo2"
                            ...
                            <div class="card-body">
                                ...
                                <ul>
                                    <li>Create detailed, comprehensive and well-structured test plans and test cases as
                                        per business requirements and technical specifications.</li>

                                    <li>Lead end-to-end manual (and preferably automation) testing for both frontend
                                        (browser) and backend (API) applications.</li>

                                    <li>Perform thorough regression testing for functional and non-functional product
                                        features.</li>

                                    <li>Collaborate with full-stack engineers and product managers to identify and
                                        understand feature requirements.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body pl-0 pr-0">
                                <div class="bg-lightgrey3 pl-4 pr-4 pb-4 pt-0 text-center">
                                    ...
                                    <h3 class="text-yellow font-weight-bold">Fullstack QA Engineer</h3>
                                ...
                                <div class="pl-4 pr-4 pt-3">
                                    ...
                                    <form id="contact-form" name="contact-form" action="mail-jobs.php" method="POST">
                                        <div class="row">
                                            <div class="col-md-12">
