            ...
            <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <h4 class="text-black font-weight-bold text-uppercase">HIRE A FIT-FOR-PURPOSE,<br /> COST-FRIENDLY, <br />DEVELOPER TEAM</h4>
                    ...
                    <div class="carousel-item">
                        <h4 class="text-black font-weight-bold text-uppercase">MAKE YOUR BUSINESS <br /> IDEA A REALITY</h4>
                    ...
                    <div class="carousel-item">
                        <h4 class="text-black font-weight-bold text-uppercase">JOIN US AND BE PART OF <br /> SOMETHING BIGGER<br /> THAN YOURSELF</h4>
