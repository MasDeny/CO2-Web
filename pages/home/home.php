            ...
            <div class="pt-5 pb-5 text-center">
                ...
                <div class="text-center" id="mobile-hidden">
                    ...
                    <p class="text-black">However, you may not have the time nor resources. You have a business to run,
                        we understand. Whatever your idea involves a website or an app,
    ...
    <section class="testimonial-form">
        <div class="container">
            <div class="pt-5 pb-5 text-center">
                <h4 class="font-weight-bold text-uppercase text-black">what our <span class="text-yellow">customer
                        say</span></h4>
                <p class="text-black">Our beloved customer’s comment on us</p>
                            ...
                            <div class="carousel-item active">
                                <div class="testimonial">
                                    ...
                                    <div class="avatar mx-auto mb-4">
                                        <img src="../assets/img/logo/techplusart.png" class="rounded-circle img-fluid"
                                            alt="First sample avatar image">
                                    </div>
                                    <!--Content-->
                                    <h4 class="font-weight-bold text-yellow">Isen Majennt</h4>
                                    <p>
                                        <i class="fas fa-quote-left"></i> Coding Collective has helped my business grow!
                                        The service was exactly as described and developers were amazing, competent and
                                        really passionate on what they do.
                                    </p>
                                    <h6 class="font-weight-bold my-3 text-yellow">Founder at Tech + Art</h6>
                                </div>
                            </div>
                            <!--First slide-->
                            <!--Second slide-->
            ...
            <div class="tell-us-home" id="tell-us-home">
                <div class="pt-5 pb-5 text-center">
                    ...
                    <form id="contact-form" name="contact-form" action="../services/mail.php" method="POST">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 mb-5">
                                <div class="text-center">
                                    <h5 class="text-uppercase font-weight-bold text-yellow mb-5">about you</h5>
                                </div>
                            ...
                            <div class="col-lg-6 col-md-6 mb-5">
                                <div class="text-center">
                                    <h5 class="text-uppercase font-weight-bold text-yellow mb-5">about the company</h5>
                                </div>
                                <div class="md-form mb-5">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 text-left">
                                <div class="mb-5">
                                    <h5 class="text-uppercase font-weight-bold text-yellow">project detail</h5>
                                </div>
                                ...
                                <div class="custom-control custom-checkbox mb-3 mt-2 d-inline-block mr-3">
                                    ...
                                    <label class="custom-control-label" for="android">Android App</label>
                                </div>
                                <div class="custom-control custom-checkbox mb-3 mt-2 d-inline-block mr-3">
                                    <input type="checkbox" class="custom-control-input" id="ios" name="ios">
                                    <label class="custom-control-label" for="ios">IOS App</label>
                                </div>
                                <p class="mt-5">What is Your Budget? <span class="text-danger">*</span></p>
